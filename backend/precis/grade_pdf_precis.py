...
def call_grok_for_precis_grading(
    ...
    *,
    ...
    instructions = (
        ...
        "Keep every comment mid-length — brief but substantive: a clear, specific sentence (about 15-30 words) naming the exact issue in this precis; good and useful, never one-word notes, vague filler, or long paragraphs.\n"
